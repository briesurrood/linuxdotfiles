...
hi LineNr               ctermfg=015     ctermbg=233
hi SignColumn           ctermfg=015     ctermbg=233
hi Folded               ctermfg=014     ctermbg=234
...
hi Constant ctermfg=214 cterm=none
hi String ctermfg=105
hi PreProc ctermfg=105
hi Visual ctermbg=235 ctermfg=none
hi MatchParen cterm=reverse ctermbg=202 ctermfg=237
hi Number ctermfg=175
hi Structure ctermfg=9
hi Exception ctermfg=9
hi StorageClass ctermfg=9
source ~/.vim/colors/generic.vim

"Vim
hi link vimHiKeyList Identifier
