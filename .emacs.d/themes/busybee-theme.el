  ...
  'busybee
	...
	'(cursor ((t (:background "#e2e2e5"))))
        ...
        '(mode-line ((t (:bold t :foreground "#898989" :background "#202020"
                         :box (:line-width 1 :color "#202020" :style released-button)))))
	...
	'(circe-server-face ((t (:foreground "#606060" :underline nil))))
	'(circe-prompt-face ((t (:foreground "#e2e2e5"))))
	'(lui-time-stamp-face ((t (:foreground "#606060" :underline nil)))))
