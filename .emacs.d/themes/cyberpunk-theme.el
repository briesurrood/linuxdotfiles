...
(let ((class '((class color) (min-colors 89)))
 ...
 (custom-theme-set-faces
   ...
   `(link ((,class (:foreground ,cyberpunk-yellow :underline t :weight normal))))
   ...
   `(mode-line
     ((,class (:foreground ,cyberpunk-fg
                           :background ,cyberpunk-gray-6
                           :box (:line-width -1 :color ,cyberpunk-gray-5 :style released-button)))))
   `(mode-line-inactive
